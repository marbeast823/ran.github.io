                    ...
                    <div class="mainMenu" onmouseover="this.style.height='360px';" onmouseout="this.style.height='90px';" style="height: 90px;" />
                        ...
                        <div id="navigation">
                            <ul id="navigation_main">
                                <li id="n-news"><a href="News.aspx"></a></li>
                            ...
                            <ul id="drop">
                                <li id="d-news" style="height: 200px;">
                                    <a href="News.aspx"><span>Focus</span></a>
                                </li>
...
<!-- end -->
    ...
    <li id="news1_bg" class="leftMenuTitle subMenu" link="NewsList.aspx?NewsCategory=1"><img id="news1" class="subMenuTitle pointer" src="../assets/Images/submenu/news/news_notice_off.gif" alt="" /></li>
    <li class="leftMenuBlank"></li>

    <li id="news3_bg" class="leftMenuTitle subMenu" link="NewsList.aspx?NewsCategory=3"><img id="news3" class="subMenuTitle pointer" src="../assets/Images/submenu/news/news_focus_off.gif" alt="" /></li>
    <li class="leftMenuBottom"></li>
    </ul>
    ...
    <div class="left"><img src="../assets/images/content/content_top_news_3.gif" alt=""></div>
    <div class="right pt5">
    ...
    <thead>
    <tr>
    <th scope="col" class="legend"></th>
    <th scope="col" class="subject">Subject</th>
    <th scope="col" class="view"></th>
    <th scope="col" class="lastPost">Date</th>
    </tr>
    </thead>
    <tbody>
    <tr><td class='legend'><img src='../assets/images/board/hot_posts_icon.gif' alt='Top posts'></td><td class='subject'><a href='../Focus/FocusView.aspx?FocusCategory=21'>NEWBIE WELCOMING KIT</a></td><td class='view'></td><td class='lastPost'><span class='date'>4/14/2023 9:49:53 PM</span></td></tr><tr><td class='legend'><img src='../assets/images/board/hot_posts_icon.gif' alt='Top posts'></td><td class='subject'><a href='../Focus/FocusView.aspx?FocusCategory=20'>Boss Mob Respawn Time</a></td><td class='view'></td><td class='lastPost'><span class='date'>7/5/2022 7:19:20 PM</span></td></tr><tr><td class='legend'><img src='../assets/images/board/hot_posts_icon.gif' alt='Top posts'></td><td class='subject'><a href='../Focus/FocusView.aspx?FocusCategory=19'>FARMABLE ITEMS</a></td><td class='view'></td><td class='lastPost'><span class='date'>10/31/2021 6:14:04 PM</span></td></tr><tr><td class='legend'><img src='../assets/images/board/hot_posts_icon.gif' alt='Top posts'></td><td class='subject'><a href='../Focus/FocusView.aspx?FocusCategory=18'>ATTENTION! MAP LEVELING GUIDE</a></td><td class='view'></td><td class='lastPost'><span class='date'>8/11/2021 6:54:13 PM</span></td></tr><tr><td class='legend'><img src='../assets/images/board/hot_posts_icon.gif' alt='Top posts'></td><td class='subject'><a href='../Focus/FocusView.aspx?FocusCategory=17'>ATTENTION! MAP LEVELING GUIDE</a></td><td class='view'></td><td class='lastPost'><span class='date'>8/11/2021 6:51:38 PM</span></td></tr>
    </tbody>
    </table>
    ...
    <div class="btnRight pb5"></div>
    <div class="forumLegend">
    <ul>
    <li><img src="../assets/images/board/new_posts_icon.gif" alt="New posts">New Post</li>
    <li><img src="../assets/images/board/hot_posts_icon.gif" alt="Important posts">Important Post</li>
    </ul>
    </div>
    </div>
    </div>
...
<script type="text/javascript">
        $(document).ready(function() {
            ...
            //$("#news3_bg").addClass("leftMenuRoll").removeClass("leftMenuTitle");

            var cate = "3";
            if (cate == 1) {
                $("#pathStr").text("NEWS > Notice");
            } else if (cate == 2) {
                $("#pathStr").text("NEWS > EVENT");
            } else if (cate == 3) {
                $("#pathStr").text("News > Events > Notice");
            }
            ...
            $("#btnWrite").click(function() {
                location.href = "NewsWrite.aspx?NewsCategory=3";
            });

            $("#btnSearch").click(function() {
                location.href = "NewsList.aspx?NewsCategory=3&SearchFlag=" + $("#selSearchFlag").val() + "&SearchString=" + $("#txtSearchString").val();
            });
        });

        function goNewsView(newsnum) {
            location.href = "NewsView.aspx?PageNum=1&NewsCategory=3&NewsNum=" + newsnum + "&SearchFlag=" + $("#selSearchFlag").val() + "&SearchString=" + $("#txtSearchString").val();
        }

        /*
        function goPaging(pagenum) {
        $("#hdnPageNum").val(pagenum);
        $("#form1").attr("action", "NewsList.aspx").submit();
        }
        */
    </script>
