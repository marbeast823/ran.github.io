...
<div class="content">
        <div class="contentTop">
            <div class="left"><img src="../assets/Images/content/content_top_down_game.gif" alt="" /></div>
            <div class="right pt5">
        ...
        <div class="contentMiddle">
            <div class="contentBox">
                ...
                <h3>Full Client Download</h3>
                <p class="tahoma12-redB pb10">- Please choose one of the following links to download full client</p>

                <div class="downloadVisualImg"><img src="../assets/images/download/jeta.gif" alt="" /></div>
                <div id="ctl00_SitePagesHolder_gameDownload" class="gameDownload"><p class='pb15'><a href='https://drive.google.com/file/d/1IzA_7yhryDCsd67BXjubb0lvbj2QzKrp/view?usp=share_link' class='pointer' onclick=&qout;Common.WebAdminRecord('GameDownload');&qout; target='_blank'><img src='../assets/Images/download/game_download_btn01_150904.gif' alt='LOCATION 01- CLIENT DOWNLOAD'></a></p><p class='pb15'><a href='https://www.mediafire.com/file/xkylfhjcwaxmk30/JNRanV4.1.exe/file' class='pointer' onclick=&qout;Common.WebAdminRecord('GameDownload');&qout; target='_blank'><img src='../assets/Images/download/game_download_btn02_150904.gif' alt='LOCATION 11- CLIENT DOWNLOAD'></a></p><p class='pb15'><a href='https://mega.nz/file/qNkWWIqJ#fKgk0EoPGyqx9aNvZwiRlQgDwXnnqhOhfgmqkTN006o' class='pointer' onclick=&qout;Common.WebAdminRecord('GameDownload');&qout; target='_blank'><img src='../assets/Images/download/game_download_btn03_150904.gif' alt='LOCATION 21- CLIENT DOWNLOAD'></a></p></div>

                <div class="guideButton" style=" height:auto;">
                    <ul>
                        <li>
                            <a href="../GameGuides/Instructions.aspx" >
                                <img src="../assets/images/download/full_guide_btn.gif" class="pointer" alt="Full Game Guide">
                            </a>
                            <span>Click to see the detailed guide of Game User Interface.</span>
                        </li>
                        <li>
                            <a href="../GameGuides/Character.aspx">
                                <img src="../assets/images/download/quick_guide_btn.gif" class="pointer" alt="Quick Game Guide">
                            </a>
                            <span>A must-read guide for beginners.</span>
                        </li>
                    </ul>
                </div>
                ...
                <table class="Requirement" border="0" cellspacing="1" summary="System Requirement" cellpadding="0">
                    <caption>System Requirement</caption>
                    <colgroup>
                        <col width="150">
                        <col width="250">
                        <col width="250">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="info">MINIMUM SPECIFICATIONS</th>
                        <th scope="col" class="info">RECOMMENDED SPECIFICATIONS</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        <td class="info">GRAPHIC CARD</td>
                        <td>Geforce 6000 + , ATI redeon X +</td>
                        <td>Geforce 6000 + , ATI redeon X +</td>
                    </tr>
                    <tr>
                        <td class="info">HARD DISK SPACE</td>
                        <td>3GB+</td>
                        <td>4GB+</td>
                    </tr>
                    <tr>
                        <td class="info">DIRECT X</td>
                        <td>DirectX 9.0c +</td>
                        <td>DirectX 9.0 + , 3D effect supportive</td>
                    </tr>
                    <tr>
                        <td class="info">CONNECTION SPEED</td>
                        <td>BROADBAND, 56K modem &amp; Wifi are not recommended</td>
                        <td>Broadband(ADSL) +</td>
                    </tr>
                    <tr>
                        <td class="info">OPERATING SYSTEM</td>
                        <td>Windows XP +</td>
                        <td>windows 7+</td>
                    </tr>
                    </tbody>
                ...
                <br>
                <span style=" color:Red">PC Specifications for running one single client.
Running multiple clients might result in lower performance and less smooth game experience.</span>
            </div>
        </div>
...
<script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#pathStr").text("Download > Game Download");
            $(".NavMenu").hover(
                function() {
                    $(this).attr("src", $(this).attr("src").replace("_on", "_off"));
                },
