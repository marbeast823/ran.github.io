...
<div class="content">
        <div class="contentTop">
            <div class="left"><img src="../assets/images/content/content_top_findinfo.gif" alt="Find ID, Password"></div>
            <div class="right pt5">
                <span id="pathStr" style="color:rgb(255,255,255);font-weight:bold;font-size:12px;">Password Reset</span>
            </div>
        </div>
        <div class="contentMiddle">
            <div class="contentBox">
                <form name="aspnetForm" method="post" action="FindIDPassword.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTIwOTMwNzA5MjVkGAEFHl9fQ29udHJvbHNSZXF1aXJlUG9zdEJhY2tLZXlfXxYBBR9jdGwwMCRTaXRlUGFnZXNIb2xkZXIkc3VibWl0QnRuyWxUgEwwdlViDSUz07CJEN/JPro=" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="9DBB4788" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwLegLGOCQLC/crGBQLp/OvfCMm0BWCiAomq/Y/U5DwnPQtEGccR" />
                    <div class="member">
                        <h2>RESET PASSWORD</h2>
                        <p class="tahoma12">Please type your registered email address, we will send you a link to reset your password.</p>
                        <div class="findPassword">
                                ...
                                <fieldset>
                                    ...
                                    <div class="field">
                                        ...
                                        <div>
                                            <input name="ctl00$SitePagesHolder$txtFindPasswordEmail" type="text" id="ctl00_SitePagesHolder_txtFindPasswordEmail" name="FindPasswordEmail" class="w355" /></p>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="textCenter">
                                <input type="image" name="ctl00$SitePagesHolder$submitBtn" id="ctl00_SitePagesHolder_submitBtn" src="../assets/images/button/submit_btn.gif" alt="Login" onclick="return validate();" border="0" /></p>
                            </div>
                        </div>
                    </div></form>
            </div>
