...
<!-- end -->
    ...
    <div class="left"><img src="images/content/content_top_game_system.gif" alt="" /></div>
    <div class="right pt5">
    <span id="pathStr" style="color: rgb(255, 255, 255); font-weight: bold; font-size: 12px;"></span>
    </div>
    </div>
    <div class="contentMiddle">
    <div class="contentBox">
    <ul id="systemListTab" class="systemList">
    <li id="tab2" class="tabMenu pointer" file="ExtraStage">Extra Stage</li>
    <li id="tab3" class="tabMenu pointer on" file="LeadClubBattle">Lead Club Battle</li>
    <li id="tab4" class="tabMenu pointer" file="ClubBattle">Club Battle</li>
    <li id="tab5" class="tabMenu pointer" file="ClubDeathMatch">Club Death Match</li>
    <li id="tab11" class="tabMenu pointer" file="Extracurricularactivity">Extracurricular activity</li>
    </ul>
    <ul id="Ul1" class="systemList">
    <li id="tab19" class="tabMenu pointer" file="ChaosItem">New Chaos</li>
     <li id="tab20" class="tabMenu pointer" file="ChaosMap">Map</li>
    <li id="tab21" class="tabMenu pointer" file="ChaosMonster">Monster</li>
    </ul>
    <div class="clear"><span></span></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".tabMenu").click(function() {
            ...
            if (tab == "19" || tab == "20" || tab == "21") {
                $('#systemInfo').load('./gamesystem/' + $(this).attr('file') + '.aspx?intInfoSel=10&kind=110111', function() {
                    setTimeout("$.modal.close()", 300);
                });
            }
            else {
                $('#systemInfo').load('./gamesystem/' + $(this).attr('file') + '.htm', function() {
                    setTimeout("$.modal.close()", 300);
                });
            }
    ...
    function NewItem(intInfoSel, intKind) {
        $('#systemInfo').load('./gamesystem/ChaosItem.aspx?intInfoSel=' + intInfoSel + '&kind=' + intKind, function() {
            setTimeout("$.modal.close()", 300);
        });
    }

    function changeGrade(intInfoSel, intKind, grade) {
        $('#systemInfo').load('./gamesystem/ChaosItem.aspx?intInfoSel=' + intInfoSel + '&kind=' + intKind + grade, function() {
            setTimeout("$.modal.close()", 300);
        });
    }
    ...
    <div id="modal" style="display:none;padding:10px;">
    ...
    <div id="Div1" class="displayNone" style="position:absolute; z-index:10;">
    <div class="">
    <div class="userProfileWrapper">
    <div class="close">
    <img src="../assets/button/close_btn2.gif" id="Img1" class="pointer" alt="Close" />
    </div>
    <div class="userProfile">
    <div class="profileImage">
    <img id="Img2" src="">
    ...
    <div class="profileInfo">
    <p id="P1" class="nickname"></p>
    <div class="characterInfo">
    <p id="P2"></p>
    <p>Forum Level : <img id="Img3"></p>
    <p>Greetings : <em id="Em1"></em></p>
    </div>
    </div>
    <div class="clear"></div>
    </div>
