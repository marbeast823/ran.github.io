...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTc1NTg3NjQ0OGQYAQUeX19Db250cm9sc1JlcXVpcmVQb3N0QmFja0tleV9fFgEFIWN0bDAwJFN1Yk5hdlBsYWNlSG9sZGVyJHN1Ym1pdEJ0bh1+yBagx7Re28yn3YXNIlzFjT/w" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="1806D926" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWBALw/PfbDAKz8pS7AgKT+LTMBQL2zvX3CxiEoDHP8ywMamuqK/iDLBiY3D1Z" />
    <fieldset>
    <div class="login_wrap">
    <div class="loginBox">
    <div class="formArea">
    <p class="left"><input name="ctl00$SubNavPlaceHolder$txtUserID" type="text" id="ctl00_SubNavPlaceHolder_txtUserID" /></p>
    <p class="left"><input name="ctl00$SubNavPlaceHolder$txtUserPassword" type="password" id="ctl00_SubNavPlaceHolder_txtUserPassword" /></p>
    </div>
    <p class="right"><input type="image" name="ctl00$SubNavPlaceHolder$submitBtn" id="ctl00_SubNavPlaceHolder_submitBtn" src="../assets/images/button/login_btn.gif" alt="Login" onclick="return validate();" border="0" /></p>
    <div>
    <p class="left"><img src="../assets/images/Common/list_icon.gif" alt="" /> New user?<a href="../Members/Register.aspx"> Sign up New!</a></p>
    <p class="left"><img src="../assets/images/Common/list_icon.gif" alt="" /> Forget your <a href="../Members/FindIDPassword.aspx"> ID or Password?</a></p>
    </div>
    </div>
    </div>
    </fieldset>
...
$(document).ready(function() {
    ...
    function LoginCheck() {
        ...
        $("#aspnetForm").attr("action", "LoginProcess.aspx").submit();
    }
